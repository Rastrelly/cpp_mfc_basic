...
// cpp_mfc_basic.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CcppmfcbasicApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CcppmfcbasicApp

CcppmfcbasicApp::CcppmfcbasicApp()
{
...
// Единственный объект CcppmfcbasicApp

CcppmfcbasicApp theApp;


// Инициализация CcppmfcbasicApp

BOOL CcppmfcbasicApp::InitInstance()
{
